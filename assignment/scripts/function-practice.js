...
//*** COMMENTS:
//  declared a reuseable function named helloName() with one parameter, name
...
//*** COMMENTS:
//   declared a function addNumbers() with two parameters (num1 and num2)- each parameter should be separated by a comma!
//  *NOTE*: parameters are variables or placeholders that will be used to pass in outside info into our function
//  inside the curly braces { } is where we want the function to perform
//  to add two numbers together we take the parameters num1 + num2
// however, we must use the keyword return before executing the procedural of num1 + num2
// because the return is the final product given back to us after the function is invoked.
// **SUMMARY: our function below is saying "take num1 and num2
//    and add them together, in 'return' is your sum of the two parameters
...
//  and in return is your product of the there parameters when function is invoked
...
//*** COMMENTS: 
//  function is verifying the parameter (number) is it positive? TRUE OR FALSE (boolean)?
//  first condition will result in 'TRUE' if the number is greater than 0
//  otherwise it will be false, because it is either 0 or a negative number
...
//*** COMMENTS:
//  declared a function named getLast()
...
console.log('Is this value (Xai) in array1? - should say false:',find('Xai', array1));
console.log('Is this value (bird) in array1? - should say true:',find('bird', array1));
console.log('Is this value (bird) in array2? - should say false:',find('bird', array2));
console.log('Is this value (apple) in array2? - should say true:',find('apple', array2));
...
//*** COMMENTS:
//  declared a function called positiveNumber, passing array as the parameter
...
console.log('New array with positive numbers:', positiveNumber(numArray1)); // empty array - there's no positive numbers in numArray1
console.log('New array with positive numbers:', positiveNumber(numArray2)); // [33, 42, 55] - positive numbers only from numArray2
...
//*** COMMENTS:
//      declared a function named reverseCapitalize(string) 
//      when invoked it will pass string to pass it through the test of in the order of:
//      split(); this method takes the string and separate the value into an array
//      reverse(); this method will take the current array order and reverse it
//      join(); this method will take the array and turn it into a string by joining together all the array elements
//      toUpperCase(): this method will capitalize a string
//      after the string goes through each of the methods above we want it to return reverse and capitalized
...
console.log('Testing:', reverseCapitalize('edabit')); // TIBADE
console.log('Testing:', reverseCapitalize('abc')); // CBA
console.log('Testing:', reverseCapitalize('hellothere')); //EREHTOLLEH
console.log('Testing:', reverseCapitalize('input')); // TUPNI
console.log('Testing:', reverseCapitalize('indubitably')); // YLBATIBUDNI
